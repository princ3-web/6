...
const Navbar = () => {
  ...
  const [navbar, toogleNavbar] = use(0)
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", position:"absolute", left:"50%", transform: "translate(-50%, 0%)" }}>
        {items.map((item) => (
          <Link to={item.link} style={{ color: "unset", textDecoration: "none" }} onClick={() =>}>
