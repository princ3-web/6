...
const Home = () => {
  ...
  const albums = [
    {
      title: "Fine Line",
      text: "is Harry Styles' critically acclaimed second solo album, showcasing his artistic evolution and versatility through a diverse range of songs that explore love, self-discovery, and emotional depth.",
      image: image4,
    },
    {
      title: "Harry Styles",
