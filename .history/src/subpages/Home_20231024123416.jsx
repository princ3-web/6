...
const Home = () => {
  const items = [
    { title: "Los Angeles, CA", date: "8/14/19" },
    { title: "New York City, NY", date: "9/21/19" },
    { title: "London, UK", date: "10/05/19" },
    { title: "Sydney, AU", date: "11/12/19" },
    { title: "Tokyo, JP", date: "12/18/19" },
    { title: "Toronto, CA", date: "1/25/20" },
    { title: "Rio de Janeiro, BR", date: "2/29/20" },
  ];
  ...
  return (
    <Box>
      ...
      >
        ...
        His music style is a captivating fusion of pop, rock, and elements of classic and contemporary sounds, creating a unique and versatile sonic experience that resonates with a broad audience.
