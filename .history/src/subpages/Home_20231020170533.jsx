...
const Home = () => {
  ...
  const albums = [
    { title: "That Was Then", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.", image: image1 },
    { title: "Turquoise Moon", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt." },
    { title: "The Distance Between Us", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt." },
  ]
      ...
      >
        ...
        <Box sx={{ width: "100%" }}>
         { <Box sx={{ width: "33%" }}>
            ...
            />
            <Typography variant="h4" color={grey[100]} sx={{ p: "1rem" }}>
              That Was Then
            </Typography>
