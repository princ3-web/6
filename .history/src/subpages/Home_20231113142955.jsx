...
>
  <Box sx={{ display: "flex", flexDirection: isMobile ? "column" : "row" }}>
    <Box sx={{ width: isMobile ? "100%" : "55%", mb: isMobile ? "2rem" : "0" }}>
      <Animated>
        <CardMedia component="img" image={image1} alt="abc" sx={{ height: isMobile ? "400px" : "800px" }} />
      </Animated>
    </Box>
    <Box sx={{ width: isMobile ? "100%" : "45%", px: isMobile ? "1rem" : "5rem" }}>
      <Typography color={grey[100]} fontWeight={"Bold"} sx={{ pt: isMobile ? "2rem" : "5rem", fontSize: isMobile ? "40px" : "70px" }}>
...
<Box
  sx={{
    ...
    width: "100%",
    m: "auto",
    px: "5%", // Adjusted padding for smaller screens
    boxSizing: "border-box",
  }}
>
  <Typography variant="h2" fontWeight={"Bold"} textAlign={"center"}>
    Harry Styles was raised near the coast, but you won't confuse his music for carefree, sunny tunes.
  </Typography>
  <Typography variant="h6" textAlign={"center"} sx={{ mt: "1rem" }}>
    He crafts narratives from the perspective of outsiders and nonconformists, injecting a fresh viewpoint and sharp humor into his stories of troubled romances. With a soulful voice influenced by jazz standards and a talented backing band, he blends a timeless sound with contemporary themes, resulting in an electrifying impact.
  </Typography>
</Box>
