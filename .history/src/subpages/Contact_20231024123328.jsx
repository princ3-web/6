    ...
    <Box sx={{ display: "flex", backgroundColor: grey[500] }}>
      ...
      >
        ...
        <Box sx={{ width: "100%" }}>
          ...
          If you're a devoted fan of Harry Styles, don't hesitate to reach out and share your admiration and support – your messages can truly brighten his day and inspire him to keep creating incredible music!
          </Typography>
        </Box>
      </Box>
      <Box
