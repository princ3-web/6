    ...
    <Box>
      ...
      >
        ...
        <Box sx={{display:"flex", flexWrap:"wrap", width:"100%"}}>
          {items.map((item) => (
            <Box sx={{width: "33%", border:"1px solid red"}}>
              <Typography variant="h4" textAlign={"center"} color={grey[100]} >{item.date}</Typography>
              <Typography textAlign={"center"}  color={grey[100]}>{item.title}</Typography>
              <Typography textAlign={"center"}  color={grey[100]}></Typography>
            </Box>
          ))}
        </Box>
      </Box>
