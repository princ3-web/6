...
const Home = ({ isMobile }) => {
  ...
  return (
    <Box>
      <Box
        sx={{
          ...
          px: isMobile ? "0rem" : "3rem", // Adjust padding for mobile
        ...
        <Box sx={{ display: "flex", flexDirection: isMobile ? "column" : "row" }}>
          <Box sx={{ width: isMobile ? "100%" : "55%", mb: isMobile ? "2rem" : "0" }}>
            <Animated>
              <CardMedia
                ...
                image={image1}
                alt="abc"
                sx={{ height: isMobile ? "600px" : "800px", width:isMobile? "100vw" :"auto" }}
              />
            </Animated>
          </Box>
          <Box sx={{ width: isMobile ? "100%" : "45%", px: isMobile ? "1rem" : "5rem" }}>
            ...
            <Typography color={grey[100]} variant="h5" sx={{ pt: "1rem" }}>
              Him new album is available now.
            </Typography>
            <Button
              variant="contained"
              sx={{
      ...
      >
        <Animated style={{ width: "100%" }}>
          <CardMedia
            ...
            image={image2}
            alt="abc"
            sx={{ width: isMobile ? "100vw" : "auto", height: isMobile ? "200px" : "400px" }}
          />
        </Animated>
      ...
      <Box sx={{ width: isMobile ? "100%" : "50%" }}>
        <Animated>
          <CardMedia component="img" image={image3} alt="abc" sx={{ height: isMobile ? "400px" : "700px" }} />
        </Animated>
      </Box>
      <Box sx={{ width: isMobile ? "100%" : "50%", px: isMobile ? "2rem" : "5rem" }}>
        <Typography color={grey[900]} fontWeight="bold" sx={{ pt: isMobile ? "2rem" : "8rem", fontSize: isMobile ? "30px" : "50px" }}>
          New Album Out Now
        </Typography>
    ...
    >
      <Typography variant="h3" fontWeight="bold" color={grey[100]} sx={{ p: isMobile ? "1rem" : "3rem" }}>
        Discography
      </Typography>
      <Typography variant="h6" color={grey[100]} sx={{ pb: isMobile ? "1rem" : "3rem", width: "80%" }}>
      ...
      >
        {albums.map((item) => (
          <Box sx={{ width: isMobile ? "100%" : "32%", textAlign: "start", mb: isMobile ? "2rem" : 0 }}>
            <Animated>
              <CardMedia
                component="img"
                image={item.image}
                alt="abc"
                sx={{ width: "100%", height: isMobile ? "250px" : "450px" }}
              />
            </Animated>
