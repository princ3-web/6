...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box sx={{ display:"flex", flexDirection:"column", backgroundColor: grey[900], p: "4rem", justifyContent:"center", textAlign:"center" }}>
        <Typography variant="h3" color={grey[100]} sx={{p:"3rem"}}>Discography</Typography>
        <Typography variant="h6" color={grey[100]}  sx={{pb:"3rem", width:"60%"}}>
